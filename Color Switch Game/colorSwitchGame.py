...
pygame.display.set_caption("Color Switch Game")
...
pygame.mixer.music.load(r'C:\Users\RANVEER\Desktop\PYTHON\Game using python\Game Project\Color-Switch-master\backgroundForColorSwitchGame.mp3');
